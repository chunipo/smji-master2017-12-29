...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if(self)
    {
        _round1Color = [UIColor colorWithRed:53.0/255.0 green:144.0/255.0 blue:242.0/255.0 alpha:1];
        _round2Color = [UIColor colorWithRed:53.0/255.0 green:144.0/255.0 blue:242.0/255.0 alpha:0.6];
        _round3Color = [UIColor colorWithRed:53.0/255.0 green:144.0/255.0 blue:242.0/255.0 alpha:0.3];
