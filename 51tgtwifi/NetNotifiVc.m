...
-(void)labelUI{
    ...
    LogoImg = [[UIImageView alloc]initWithFrame:CGRectMake((XScreenWidth-128)/2, 20+44+X_bang+20, 128, 128)];
    LogoImg.image = [UIImage imageNamed:@"WechatIMG8.png"];
    [self.view addSubview:LogoImg];
    labDetai = [[UILabel alloc]initWithFrame:CGRectMake(20, viewBack.maxY, XScreenWidth-2*20, 400)];
    labDetai.text = @"百度翻译机是基于百度语音识别合成及神经网络翻译等人工智能技术，融合途鸽自主专利的全球云通信科技，它可以在中英、中日等互译模式中自动识别语种，实现一键语音实时翻译，使翻译机真正告别了两键时代。从某种意义上来说，很有可能会改变上千万游客在跨境旅行中的出行模式。从此全球旅行，更加自由自在。\n下面您可通过扫描百度翻译机二维码/条形码以此绑定/激活设备。注意事项：\n\n1.请保持您的手机网络畅通.\n2.如果需要连接设备，请记得打开您的蓝牙开关.\n3.点击右上方按钮开始扫描二维码.";
